      ...
      <div className="container" style={{height: 250}}>
        <div className="row justify-content-center">
          ...
          <div className="col-md-4 text-center">
            <h5>Ressources</h5>
            <Link to="/contact">
            <p className="resources-item" style={{color: "#282830", textDecoration:"None", fontSize: "1rem",marginRight: "10px", marginBottom:-25}}>Support</p>
            </Link>
            <Link to="/blog">
            <p className="resources-item" style={{color: "#282830", textDecoration:"None", fontSize: "1rem",marginRight: "10px", marginBottom:-25}}>Blog</p>
            </Link>
            <Link to="/contact#faq-section">
            <p className="resources-item" style={{color: "#282830", textDecoration:"None", fontSize: "1rem",marginRight: "10px"}}>FAQ</p>
            </Link>
          </div>
          <div className="col-md-4 text-center">
